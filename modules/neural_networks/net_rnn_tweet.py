...
class Net_Rnn_Tweet(nn.Module):
    def __init__(self, vocab_size=19, output_size=4, embedding_dim=85, hidden_dim=256, n_layers=1, drop_prob=0.5):
        super(Net_Rnn_Tweet, self).__init__()
        # Variables
